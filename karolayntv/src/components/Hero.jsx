...
const defaultSlides = [
  {
    ...
    accent: '#e63946',
    image: '',
    gradient: 'linear-gradient(135deg, #1a0808 0%, #3d0f0f 50%, #0a0505 100%)'
  },
  {
    label: 'Creadora de Contenidos',
    accent: '#4361ee',
    image: '',
    gradient: 'linear-gradient(135deg, #080a1a 0%, #101840 50%, #050508 100%)'
  },
  {
    label: 'Publicidad Digital',
    accent: '#f4a261',
    image: '',
    gradient: 'linear-gradient(135deg, #1a080f 0%, #3d0f20 50%, #0a0508 100%)'
  },
  {
    label: 'Influencer & UGC',
    accent: '#4ade80',
    image: '',
    gradient: 'linear-gradient(135deg, #08150a 0%, #0f3018 50%, #050a05 100%)'
  },
]
    ...
    <section className={styles.hero} id="hero">
      ...
      <div className={styles.scrollHint}>
        ...
        <div
          ...
          style={{
            background: `linear-gradient(to bottom, ${slide.accent}, transparent)`
          }}
        />
